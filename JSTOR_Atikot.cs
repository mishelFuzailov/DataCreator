    ...
    class JSTOR_Atikot_55_90
    {
        private static int RecordSourceTable(Dictionary<string, string> row)
        {
            using (ProjectDB db = new ProjectDB())
            {
                ...
                int recordID = GetID.RecordSourchID(rowID, "JSTOR_atikot_55-90");
                ...
                if (rs is null)
                {
                    ...
                    rs.sourceID = rowID;
                    rs.recordSourceTable = "JSTOR_atikot_55-90";
                ...
                {
                    Functions.ErrorLogging(ex, "RecordSourchTable", rowID, "JSTOR_atikot_55-90");
                }
                ...
                using (ProjectDB db = new ProjectDB())
                {
                    ...
                    if (ptID != -1)
                    {
                        ...
                        if (pt is null)
                        {
                            ...
                            {
                                Functions.ErrorLogging(ex, "JSTOR_atikot_55-90", i, "PublicationType");
                            }
                        }
                    }
                    ...
                    {
                        Functions.ErrorLogging(ex, "JSTOR_atikot_55-90", i, "Publication (cols- Intro, URL, year, pubType, periodicalsID)");
                    }
                    ...
                    {
                        Functions.ErrorLogging(ex, "JSTOR_atikot_55-90", i, "Publisher-Author");
                    }
                    ...
                    if (ap is null)
                    {
                        ...
                        {
                            Functions.ErrorLogging(ex, "JSTOR_atikot_55-90", i, "Author-Publication");
                        }
                    }
    ...
    class JSTOR_Atikot_91
    {
        private static int RecordSourceTable(Dictionary<string, string> row)
        {
            using (ProjectDB db = new ProjectDB())
            {
                ...
                // insert row into
                int rowID = Functions.SerialNumber(row["Serial Number"]);
                int recordID = GetID.RecordSourchID(rowID, "JSTOR_atikot_91");
                RecordSource rs = db.RecordSources.Find(recordID);
                var date = Functions.CreateExcDate(row["Time Downloaded"]);
                if (rs is null)
                {
                    ...
                    rs.recordID = recordID;
                    rs.sourceID = rowID;
                    rs.recordSourceTable = "JSTOR_atikot_91";
                    db.RecordSources.Add(rs);
                }
                rs.updateDate = date;
                try
                ...
                {
                    Functions.ErrorLogging(ex, "RecordSourchTable", rowID, "JSTOR_atikot_91");
                }
                ...
                using (ProjectDB db = new ProjectDB())
                {
                    ...
                    if (ptID != -1)
                    {
                        ...
                        if (pt is null)
                        {
                            ...
                            {
                                Functions.ErrorLogging(ex, "JSTOR_atikot_91", i, "PublicationType");
                            }
                        }
                    }
                    Functions.InsertToConnectionTable(rowID, ptID, "PublicationType");
                    ...
                    pub.URL = row["url"];
                    pub.abstractEng = pub.abstractHeb = row["Abstract"];
                    if (ptID > 0) pub.publicationTypeID = ptID;
                    try
                    {
                        db.SaveChanges();
                    ...
                    {
                        Functions.ErrorLogging(ex, "JSTOR_atikot_91", i, "Publication (cols- Intro, URL, year, pubType, periodicalsID)");
                    }
                    ...
                    {
                        Functions.ErrorLogging(ex, "JSTOR_atikot_91", i, "Publisher-Author");
                    }
                    ...
                    if (ap is null)
                    {
                        ...
                        {
                            Functions.ErrorLogging(ex, "JSTOR_atikot_91", i, "Author-Publication");
                        }
                    }
