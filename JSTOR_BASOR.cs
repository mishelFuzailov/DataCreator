    ...
    class JSTOR_BASOR
    {
        ...
        private static int RecordSourceTable(Dictionary<string, string> row)
        {
            using (ProjectDB db = new ProjectDB())
            {
                ...
                int recordID = GetID.RecordSourchID(rowID, "JSTOR_BASOR");
                ...
                if (rs is null)
                {
                    ...
                    rs.sourceID = rowID;
                    rs.recordSourceTable = "JSTOR_BASOR";
                ...
                {
                    Functions.ErrorLogging(ex, "RecordSourchTable", rowID, "JSTOR_BASOR");
                }
                ...
                using (ProjectDB db = new ProjectDB())
                {
                    ...
                    if (ptID != -1)
                    {
                        ...
                        if (pt is null)
                        {
                            ...
                            {
                                Functions.ErrorLogging(ex, "JSTOR_BASOR", i, "PublicationType");
                            }
                        }
                    }
                    ...
                    {
                        Functions.ErrorLogging(ex, "JSTOR_BASOR", i, "Publication (cols- Intro, URL, year, pubType, periodicalsID)");
                    }
                    ...
                    {
                        Functions.ErrorLogging(ex, "JSTOR_BASOR", i, "Publisher-Author");
                    }
                    ...
                    if (ap is null)
                    {
                        ...
                        {
                            Functions.ErrorLogging(ex, "JSTOR_BASOR", i, "Author-Publication");
                        }
                    }
